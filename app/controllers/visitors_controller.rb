class VisitorsController < ApplicationController
  ...
  private
    ...
    def visitor_params
      params.require(:visitor).permit(:first_name, :last_name, :street_address, :city, :state, :zip, :phone, :email, :marital_status, :first_time_visitor, :more_info_requested, :new_to_area, :visit_requested, :learn_about_jesus)
    end
end
